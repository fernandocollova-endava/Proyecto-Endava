    ...
    return (
      <div>
        ...
        <AllowanceList
          ...
          handleFilterPeriod={this.handleFilterPeriod}
        />
      </div>
    );
  }
...
const MapDispatchToProps = dispatch => {
  return {
    fetchAllowances: (month, userId, allowanceId, status, allUser) =>
      dispatch(fetchAllowances(month, userId, allowanceId, status, allUser)),
